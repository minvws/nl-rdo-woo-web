...
export const dateFilters = () => {
  ...
  const initialize = (
    ...
    const dateFromElement = document.getElementById(
      'date-from',
    ) as HTMLInputElement;
    const dateToElement = document.getElementById(
      'date-to',
    ) as HTMLInputElement;
    ...
    [dateFromElement, dateToElement].forEach((dateElement) => {
      dateElement.addEventListener(
        ...
        () => {
          ...
          const params = isDateInvalid(date)
            ? getSearchParamsAndDelete(name)
            : getSearchParamsAndSet(name, date);
  ...
  const updateDateElements = (
    dateFromElement: HTMLInputElement,
    dateToElement: HTMLInputElement,
  ) => {
  ...
  const setDateRestriction = (
    dateElement: HTMLInputElement,
    targetDate: string,
    attributeName: 'max' | 'min',
  ) => {
  ...
  const markDateElementsAsInvalid = (
    dateFromElement: HTMLInputElement,
    dateToElement: HTMLInputElement,
  ) => {
    showInputError();
  ...
  const getInputErrorElement = () =>
    document.getElementById(ID_OF_INPUT_ERROR_ELEMENT) ?? null;
