export const manageWidget = () => {
  ...
  const initialize = () => {
    ...
    const widgetsContainer = document.getElementById('js-widgets-container') as HTMLDivElement;
    ...
    const addButton = document.getElementById('js-add-widget') as HTMLButtonElement;
  ...
  const addRemoveWidgetFunctionality = () => {
    ...
    const removeButtons: NodeListOf<HTMLButtonElement> = document.querySelectorAll('.js-remove-widget')!;
