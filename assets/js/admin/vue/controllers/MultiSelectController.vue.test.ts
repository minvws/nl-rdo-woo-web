...
import MultiSelectController from './MultiSelectController.vue';
...
describe('The "MultiSelectController" component', () => {
  ...
  test('should display a <MultiSelect /> component', async () => {
    ...
    expect(multiSelectComponent.props('buttonText')).toEqual(
      'mocked_button_text',
    );
    expect(multiSelectComponent.props('buttonTextMultiple')).toEqual(
    ...
    expect(multiSelectComponent.props('submitErrors')).toEqual(
      mockedSubmitErrors,
    );
