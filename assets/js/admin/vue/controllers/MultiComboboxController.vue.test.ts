...
import MultiComboboxController from './MultiComboboxController.vue';
...
describe('The "MultiComboboxController" component', () => {
  ...
  const getMultiComboboxComponent = () =>
    createComponent().findComponent({ name: 'MultiCombobox' });
  ...
  test('should display a <MultiCombobox /> component', async () => {
    ...
    expect(multiComboboxComponent.props('buttonText')).toEqual(
      'mocked_button_text',
    );
    expect(multiComboboxComponent.props('buttonTextMultiple')).toEqual(
      'mocked_button_text_multiple',
    );
    expect(multiComboboxComponent.props('helpText')).toEqual(
      'mocked_help_text',
    );
    ...
    expect(multiComboboxComponent.props('submitErrors')).toEqual(
      mockedSubmitErrors,
    );
