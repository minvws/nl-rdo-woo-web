...
use Shared\Service\Search\Query\Aggregation\NestedTermsAggregationStrategy;
...
readonly class PeriodFacet implements FacetDefinitionInterface
{
    ...
    {
        return FacetKey::PERIOD;
    }

    public function getField(): ElasticField
    {
        return ElasticField::DATE_PERIOD;
    }
    ...
    {
        return new NestedTermsAggregationStrategy('dossiers');
    }
    ...
    {
        return TranslatedFacetDisplayValue::fromString('global.period');
    }
