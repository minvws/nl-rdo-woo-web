...
use Shared\Service\Search\Query\Filter\MainTypesAndNestedMainTypesFilter;
use Shared\Service\Search\Query\Filter\OrTermFilter;
use Symfony\Component\HttpFoundation\ParameterBag;

use function sprintf;

readonly class PrefixedDossierNumberFacet implements FacetDefinitionInterface
{
    public function getKey(): FacetKey
    {
        return FacetKey::PREFIXED_DOSSIER_NUMBER;
    }

    public function getField(): ElasticField
    {
        return ElasticField::PREFIXED_DOSSIER_NUMBER;
    }
    ...
    {
        return new MainTypesAndNestedMainTypesFilter(new OrTermFilter());
    }
    ...
    {
        return TranslatedFacetDisplayValue::fromString('admin.dossiers.decision.number');
    }
    ...
    public function getDisplayValue(int|string $key, string $value): FacetDisplayValueInterface
    {
        return UntranslatedStringFacetDisplayValue::fromString(
            PrefixedDossierNumber::withoutPrefix($value),
        );
    }
