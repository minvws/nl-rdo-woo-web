...
readonly class ReferredDocumentNumberFacet implements FacetDefinitionInterface
{
    public function getKey(): FacetKey
    {
        return FacetKey::REFERRED_DOCUMENT_NUMBER;
    }
    ...
    {
        return TranslatedFacetDisplayValue::fromString('public.documents.referred_by');
    }
