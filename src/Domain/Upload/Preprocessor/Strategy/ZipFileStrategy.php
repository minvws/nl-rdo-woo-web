...
final readonly class ZipFileStrategy implements FilePreprocessorStrategyInterface
{
    public function __construct(private Extractor $zipExtractor)
    {
    }
    ...
    {
        foreach ($this->zipExtractor->getFiles($file) as $extractedFile) {
    ...
    {
        return $file->getOriginalFileExtension() === 'zip';
    }
}
