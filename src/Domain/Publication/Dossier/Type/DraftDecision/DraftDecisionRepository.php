...
use Shared\Domain\Search\Result\Dossier\DraftDecision\DraftDecisionSearchResult;
use Shared\Domain\Search\Result\Dossier\ProvidesDossierTypeSearchResultInterface;

use function sprintf;

/**
 * @extends AbstractDossierRepository<DraftDecision>
 */
class DraftDecisionRepository extends AbstractDossierRepository implements ProvidesDossierTypeSearchResultInterface
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, DraftDecision::class);
    }
    ...
    public function getSearchResultViewModel(
        ...
        $qb = $this->createQueryBuilder('dos')
            ->select(sprintf(
                ...
                DraftDecisionSearchResult::class,
            ))
