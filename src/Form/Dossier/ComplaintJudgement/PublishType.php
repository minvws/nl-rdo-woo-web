...
class PublishType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add('publication_date', DateType::class, [
            'label' => 'admin.dossiers.complaint-judgement.form.publication.publication_date_label',
            'help' => 'admin.dossiers.complaint-judgement.form.publication.publication_date_help',
            'required' => true,
            'widget' => 'single_text',
