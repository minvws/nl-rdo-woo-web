    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ->add('title', TextType::class, [
                'label' => 'admin.dossiers.investigation-report.form.details.title',
                'required' => true,
                /*
                 ...
                 */
                'help' => 'admin.dossiers.investigation-report.form.details.description',
                'help_html' => true,
                'attr' => [
                    'class' => 'w-full',
                ],
            ...
            ->add('date', DateType::class, [
                'required' => true,
                'label' => 'admin.dossiers.investigation-report.form.details.date_label',
                'widget' => 'single_text',
                'input' => 'datetime_immutable',
                'property_path' => 'dateFrom',
            ])
            ->add('internal_reference', TextType::class, [
                'label' => 'admin.dossiers.investigation-report.form.details.internal_reference_label',
                'required' => false,
                'help' => 'admin.dossiers.investigation-report.form.details.internal_reference_help',
                'help_html' => false,
                'attr' => [
        ...
        if ($dossier->getStatus()->isNew()) {
            $builder
                ->add('dossierNr', TextType::class, [
                    'label' => 'admin.dossiers.investigation-report.form.details.ref_number',
                    'required' => true, // @codingStandardsIgnoreStart
                    'help' => 'admin.dossiers.investigation-report.form.details.ref_nr_help', // @codingStandardsIgnoreEnd
                    'help_html' => true,
                    'empty_data' => '',
                ])
