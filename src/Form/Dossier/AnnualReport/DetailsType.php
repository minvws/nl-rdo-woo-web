    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ->add('title', TextType::class, [
                'label' => 'admin.dossiers.annual_report.form.details.title',
                'required' => true,
                /*
                 ...
                 */
                'help' => 'admin.dossiers.annual_report.form.details.description',
                'help_html' => true,
                'attr' => [
                    'class' => 'w-full',
                ],
            ...
            ->add('year', YearType::class, [
                ...
                'row_attr' => [
                    'data-fieldset' => 'year',
                    'data-legend' => 'admin.dossiers.annual_report.form.details.date_legend',
                    'data-required' => true,
                ],
                'required' => true,
            ...
            ->add('internal_reference', TextType::class, [
                'label' => 'admin.dossiers.annual_report.form.details.internal_reference_label',
                'required' => false,
                'help' => 'admin.dossiers.annual_report.form.details.internal_reference_help',
                'help_html' => false,
                'attr' => [
        ...
        if ($dossier->getStatus()->isNew()) {
            $builder
                ->add('dossierNr', TextType::class, [
                    ...
                    'help' => 'admin.dossiers.annual_report.form.details.ref_nr_help', // @codingStandardsIgnoreEnd
                    'help_html' => true,
                    'empty_data' => '',
                    'attr' => [
                        'class' => 'bhr-input-text w-full',
