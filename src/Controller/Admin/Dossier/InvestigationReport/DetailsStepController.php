...
class DetailsStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/investigation-report/details/concept/{documentPrefix}/{dossierNumber}',
    ...
    #[Route(
        path: '/balie/dossier/investigation-report/details/edit/{documentPrefix}/{dossierNumber}',
