...
class ContentStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/investigation-report/content/concept/{prefix}/{dossierNumber}',
        name: 'app_admin_dossier_investigationreport_content_concept',
        methods: ['GET', 'POST'],
    )]
    #[IsGranted('AuthMatrix.dossier.create', subject: 'dossier')]
    public function concept(
        #[MapEntity(mapping: ['prefix' => 'documentPrefix', 'dossierNumber' => 'dossierNumber'])] InvestigationReport $dossier,
        Request $request,
    ...
    #[Route(
        path: '/balie/dossier/investigation-report/content/edit/{prefix}/{dossierNumber}',
