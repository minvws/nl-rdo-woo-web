...
use Shared\Form\Dossier\InvestigationReport\PublishType;
...
class PublicationStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/investigation-report/publish/concept/{documentPrefix}/{dossierNumber}',
    ...
    #[Route(
        path: '/balie/dossier/investigation-report/publish/edit/{documentPrefix}/{dossierNumber}',
