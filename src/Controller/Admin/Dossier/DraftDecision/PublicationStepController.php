...
use Shared\Form\Dossier\DraftDecision\PublishType;
...
class PublicationStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/draft-decision/publish/concept/{documentPrefix}/{dossierNumber}',
        name: 'app_admin_dossier_draftdecision_publication_concept',
        methods: ['GET', 'POST'],
    )]
    ...
    public function concept(
        ...
        return $this->render('admin/dossier/draft-decision/publication/concept.html.twig', [
            'dossier' => $dossier,
    ...
    #[Route(
        path: '/balie/dossier/draft-decision/publish/edit/{documentPrefix}/{dossierNumber}',
        name: 'app_admin_dossier_draftdecision_publication_edit',
        methods: ['GET', 'POST'],
    )]
    ...
    public function edit(
        ...
        $this->stepHelper->addDossierToBreadcrumbs($breadcrumbs, $dossier, 'admin.dossiers.draft-decision.step.publication');

        return $this->render('admin/dossier/draft-decision/publication/edit.html.twig', [
            'breadcrumbs' => $breadcrumbs,
            'dossier' => $dossier,
            'workflowStatus' => $wizardStatus,
            'form' => $form,
