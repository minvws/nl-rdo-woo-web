...
use Shared\Form\Dossier\DraftDecision\DetailsType;
...
class DetailsStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/draft-decision/details/create',
        name: 'app_admin_dossier_draftdecision_details_create',
        methods: ['GET', 'POST'],
    )]
    #[IsGranted('AuthMatrix.dossier.create')]
    public function create(Request $request): Response
    {
        $dossier = $this->dossierFactory->create(DossierType::DRAFT_DECISION);
        ...
        return $this->render('admin/dossier/draft-decision/details/concept.html.twig', [
            'dossier' => $dossier,
    ...
    #[Route(
        path: '/balie/dossier/draft-decision/details/concept/{documentPrefix}/{dossierNumber}',
        name: 'app_admin_dossier_draftdecision_details_concept',
        methods: ['GET', 'POST'],
    )]
    ...
    public function concept(
        ...
        $breadcrumbs->addItem('admin.dossiers.draft-decision.step.details');
    ...
    #[Route(
        path: '/balie/dossier/draft-decision/details/edit/{documentPrefix}/{dossierNumber}',
        name: 'app_admin_dossier_draftdecision_details_edit',
        methods: ['GET', 'POST'],
    )]
    ...
    public function edit(
        ...
        $this->stepHelper->addDossierToBreadcrumbs($breadcrumbs, $dossier, 'admin.dossiers.draft-decision.step.details');
        ...
        return $this->render('admin/dossier/draft-decision/details/edit.html.twig', [
            'breadcrumbs' => $breadcrumbs,
            'dossier' => $dossier,
            'workflowStatus' => $wizardStatus,
            'form' => $form,
