...
class PublicationStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/request-for-advice/publish/concept/{documentPrefix}/{dossierNumber}',
    ...
    #[Route(
        path: '/balie/dossier/request-for-advice/publish/edit/{documentPrefix}/{dossierNumber}',
