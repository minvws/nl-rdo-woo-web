...
class DetailsStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/request-for-advice/details/concept/{documentPrefix}/{dossierNumber}',
    ...
    #[Route(
        path: '/balie/dossier/request-for-advice/details/edit/{documentPrefix}/{dossierNumber}',
