...
namespace Shared\Controller\Admin\Dossier\Covenant;
...
use Shared\Form\Dossier\Covenant\ContentFormType;
...
class ContentStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/covenant/content/concept/{documentPrefix}/{dossierNumber}',
    ...
    #[Route(
        path: '/balie/dossier/covenant/content/edit/{documentPrefix}/{dossierNumber}',
