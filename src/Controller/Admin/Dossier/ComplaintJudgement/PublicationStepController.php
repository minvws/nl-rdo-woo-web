...
use Shared\Form\Dossier\ComplaintJudgement\PublishType;
...
class PublicationStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/complaint-judgement/publish/concept/{documentPrefix}/{dossierNumber}',
    ...
    public function concept(
        ...
        return $this->render('admin/dossier/complaint-judgement/publication/concept.html.twig', [
            'dossier' => $dossier,
    ...
    #[Route(
        path: '/balie/dossier/complaint-judgement/publish/edit/{documentPrefix}/{dossierNumber}',
    ...
    public function edit(
        ...
        $this->stepHelper->addDossierToBreadcrumbs($breadcrumbs, $dossier, 'admin.dossiers.complaint-judgement.step.publication');

        return $this->render('admin/dossier/complaint-judgement/publication/edit.html.twig', [
            'breadcrumbs' => $breadcrumbs,
            'dossier' => $dossier,
            'workflowStatus' => $wizardStatus,
            'form' => $form,
