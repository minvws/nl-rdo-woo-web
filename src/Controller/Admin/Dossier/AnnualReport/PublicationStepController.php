...
use Shared\Form\Dossier\AnnualReport\PublishType;
...
class PublicationStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/annual-report/publish/concept/{documentPrefix}/{dossierNumber}',
    ...
    #[Route(
        path: '/balie/dossier/annual-report/publish/edit/{documentPrefix}/{dossierNumber}',
