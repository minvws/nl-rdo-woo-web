...
use App\Form\Dossier\AnnualReport\ContentFormType;
...
class ContentStepController extends AbstractController
{
    ...
    public function concept(
        ...
        return $this->render('admin/dossier/annual-report/content/concept.html.twig', [
            'dossier' => $dossier,
            ...
            'documentTypes' => $this->attachmentTypeFactory->makeAsArray(AnnualReportDocument::getAllowedTypes()),
            'attachmentTypes' => $this->attachmentTypeFactory->makeAsArray(AnnualReportAttachment::getAllowedTypes()),
    ...
    public function edit(
        ...
        return $this->render('admin/dossier/annual-report/content/edit.html.twig', [
            'breadcrumbs' => $breadcrumbs,
            'dossier' => $dossier,
            'workflowStatus' => $wizardStatus,
            'form' => $form,
