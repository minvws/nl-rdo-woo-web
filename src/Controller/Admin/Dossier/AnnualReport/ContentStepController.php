...
use Shared\Form\Dossier\AnnualReport\ContentFormType;
...
class ContentStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/annual-report/content/concept/{documentPrefix}/{dossierNumber}',
        name: 'app_admin_dossier_annualreport_content_concept',
        methods: ['GET', 'POST'],
    )]
    #[IsGranted('AuthMatrix.dossier.create', subject: 'dossier')]
    public function concept(
        #[MapEntity(mapping: ['documentPrefix' => 'documentPrefix', 'dossierNumber' => 'dossierNumber'])] AnnualReport $dossier,
        Request $request,
        ...
        return $this->render(
            'admin/dossier/annual-report/content/concept.html.twig',
    ...
    #[Route(
        path: '/balie/dossier/annual-report/content/edit/{documentPrefix}/{dossierNumber}',
    ...
    public function edit(
        ...
        $this->stepHelper->addDossierToBreadcrumbs($breadcrumbs, $dossier, 'admin.dossiers.annual-report.step.content');
        ...
        return $this->render(
            'admin/dossier/annual-report/content/edit.html.twig',
            $this->stepHelper->getParamsBuilder($dossier)
                ->withMainDocumentParams($dossier)
                ->withAttachmentsParams($dossier)
                ->withNoticeNotPublicParams($dossier)
