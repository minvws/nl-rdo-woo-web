...
class ContentStepController extends AbstractController
{
    ...
    public function concept(
        ...
        return $this->render('admin/dossier/disposition/content/concept.html.twig', [
            'dossier' => $dossier,
            ...
            'documentTypes' => $this->attachmentTypeFactory->makeAsArray(DispositionDocument::getAllowedTypes()),
            'attachmentTypes' => $this->attachmentTypeFactory->makeAsArray(DispositionAttachment::getAllowedTypes()),
    ...
    public function edit(
        ...
        return $this->render('admin/dossier/disposition/content/edit.html.twig', [
            'breadcrumbs' => $breadcrumbs,
            'dossier' => $dossier,
            'workflowStatus' => $wizardStatus,
            'form' => $form,
