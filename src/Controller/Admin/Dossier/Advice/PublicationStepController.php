...
use Shared\Form\Dossier\Advice\PublishType;
...
class PublicationStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/advice/publish/concept/{documentPrefix}/{dossierNumber}',
    ...
    #[Route(
        path: '/balie/dossier/advice/publish/edit/{documentPrefix}/{dossierNumber}',
