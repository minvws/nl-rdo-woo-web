...
use Shared\Form\Dossier\Advice\DetailsType;
...
class DetailsStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/advice/details/create',
        name: 'app_admin_dossier_advice_details_create',
        methods: ['GET', 'POST'],
    )]
    ...
    public function create(Request $request): Response
    {
        ...
        return $this->render('admin/dossier/advice/details/concept.html.twig', [
            'dossier' => $dossier,
    ...
    #[Route(
        path: '/balie/dossier/advice/details/concept/{documentPrefix}/{dossierNumber}',
        name: 'app_admin_dossier_advice_details_concept',
        methods: ['GET', 'POST'],
    )]
    #[IsGranted('AuthMatrix.dossier.create', subject: 'dossier')]
    public function concept(
        #[MapEntity(mapping: ['documentPrefix' => 'documentPrefix', 'dossierNumber' => 'dossierNumber'])] Advice $dossier,
        Request $request,
    ...
    #[Route(
        path: '/balie/dossier/advice/details/edit/{documentPrefix}/{dossierNumber}',
    ...
    public function edit(
        ...
        $this->stepHelper->addDossierToBreadcrumbs($breadcrumbs, $dossier, 'admin.dossiers.advice.step.details');
        ...
        return $this->render('admin/dossier/advice/details/edit.html.twig', [
            'breadcrumbs' => $breadcrumbs,
            'dossier' => $dossier,
            'workflowStatus' => $wizardStatus,
            'form' => $form,
