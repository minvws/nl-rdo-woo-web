...
use Shared\Form\Dossier\OtherPublication\PublishType;
...
class PublicationStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/other-publication/publish/concept/{documentPrefix}/{dossierNumber}',
    ...
    public function concept(
        ...
        return $this->render('admin/dossier/other-publication/publication/concept.html.twig', [
            'dossier' => $dossier,
    ...
    #[Route(
        path: '/balie/dossier/other-publication/publish/edit/{documentPrefix}/{dossierNumber}',
        name: 'app_admin_dossier_otherpublication_publication_edit',
        methods: ['GET', 'POST'],
    )]
    ...
    public function edit(
        ...
        $this->stepHelper->addDossierToBreadcrumbs($breadcrumbs, $dossier, 'admin.dossiers.other-publication.step.publication');

        return $this->render('admin/dossier/other-publication/publication/edit.html.twig', [
            'breadcrumbs' => $breadcrumbs,
            'dossier' => $dossier,
            'workflowStatus' => $wizardStatus,
            'form' => $form,
