...
use Shared\Form\Dossier\OtherPublication\ContentFormType;
...
class ContentStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/other-publication/content/concept/{documentPrefix}/{dossierNumber}',
    ...
    #[Route(
        path: '/balie/dossier/other-publication/content/edit/{documentPrefix}/{dossierNumber}',
