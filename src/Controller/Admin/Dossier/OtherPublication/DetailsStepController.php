...
namespace Shared\Controller\Admin\Dossier\OtherPublication;
...
use Shared\Form\Dossier\OtherPublication\DetailsType;
...
class DetailsStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/other-publication/details/create',
        name: 'app_admin_dossier_otherpublication_details_create',
        methods: ['GET', 'POST'],
    )]
    #[IsGranted('AuthMatrix.dossier.create')]
    public function create(Request $request): Response
    {
        $dossier = $this->dossierFactory->create(DossierType::OTHER_PUBLICATION);
        ...
        return $this->render('admin/dossier/other-publication/details/concept.html.twig', [
            'dossier' => $dossier,
    ...
    #[Route(
        path: '/balie/dossier/other-publication/details/concept/{documentPrefix}/{dossierNumber}',
        name: 'app_admin_dossier_otherpublication_details_concept',
        methods: ['GET', 'POST'],
    )]
    #[IsGranted('AuthMatrix.dossier.create', subject: 'dossier')]
    public function concept(
        #[MapEntity(mapping: ['documentPrefix' => 'documentPrefix', 'dossierNumber' => 'dossierNumber'])] OtherPublication $dossier,
        Request $request,
        ...
        $breadcrumbs->addItem('admin.dossiers.other-publication.step.details');
    ...
    #[Route(
        path: '/balie/dossier/other-publication/details/edit/{documentPrefix}/{dossierNumber}',
        name: 'app_admin_dossier_otherpublication_details_edit',
        methods: ['GET', 'POST'],
    )]
    ...
    public function edit(
        ...
        $this->stepHelper->addDossierToBreadcrumbs($breadcrumbs, $dossier, 'admin.dossiers.other-publication.step.details');
        ...
        return $this->render('admin/dossier/other-publication/details/edit.html.twig', [
            'breadcrumbs' => $breadcrumbs,
            'dossier' => $dossier,
            'workflowStatus' => $wizardStatus,
            'form' => $form,
