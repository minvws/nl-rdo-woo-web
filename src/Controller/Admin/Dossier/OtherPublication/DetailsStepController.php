...
class DetailsStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/other-publication/details/concept/{prefix}/{dossierId}',
    ...
    #[Route(
        path: '/balie/dossier/other-publication/details/edit/{prefix}/{dossierId}',
