...
class DetailsStepController extends AbstractController
{
    ...
    #[Route(
        path: '/balie/dossier/other-publication/details/concept/{prefix}/{dossierNumber}',
        name: 'app_admin_dossier_otherpublication_details_concept',
        methods: ['GET', 'POST'],
    )]
    #[IsGranted('AuthMatrix.dossier.create', subject: 'dossier')]
    public function concept(
        #[MapEntity(mapping: ['prefix' => 'documentPrefix', 'dossierNumber' => 'dossierNumber'])] OtherPublication $dossier,
        Request $request,
    ...
    #[Route(
        path: '/balie/dossier/other-publication/details/edit/{prefix}/{dossierNumber}',
