...
#[ApiResource(
    uriTemplate: '/dossiers/{dossierId}/other-publication-document/{mainDocumentId}',
    operations: [
        new Get(
            security: "is_granted('AuthMatrix.dossier.read')",
        ),
        new GetCollection(
            uriTemplate: '/dossiers/{dossierId}/other-publication-document',
            uriVariables: [
                'dossierId' => new Link(toProperty: 'dossier', fromClass: DossierReferenceDto::class),
            ],
            security: "is_granted('AuthMatrix.dossier.read')",
            itemUriTemplate: '/dossiers/{dossierId}/other-publication-document/{mainDocumentId}',
        ),
        new Post(
            uriTemplate: '/dossiers/{dossierId}/other-publication-document',
            uriVariables: [
    ...
    provider: OtherPublicationMainDocumentProvider::class,
    processor: OtherPublicationMainDocumentProcessor::class,
)]
final readonly class OtherPublicationMainDocumentDto extends AbstractMainDocumentDto
{
}
