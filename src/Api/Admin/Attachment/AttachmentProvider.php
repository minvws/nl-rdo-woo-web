...
abstract readonly class AttachmentProvider implements ProviderInterface
{
     ...
     *
     * @return array<array-key,AttachmentDto>|AttachmentDto|object[]|null
     */
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): array|AttachmentDto|null
    {
        unset($context);
        ...
        if ($operation instanceof CollectionOperationInterface) {
            return $this->getAttachmentRepository()
                ...
                ->map(fn (AbstractAttachment $entity): AttachmentDto => $this->fromEntityToDto($entity))
                ->toArray();
        }
