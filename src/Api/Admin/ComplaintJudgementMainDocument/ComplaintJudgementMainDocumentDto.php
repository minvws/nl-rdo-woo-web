...
#[ApiResource(
    uriTemplate: '/dossiers/{dossierId}/complaint-judgement-document/{mainDocumentId}',
    operations: [
        new Get(
        ...
        new GetCollection(
            ...
            security: "is_granted('AuthMatrix.dossier.read')",
            itemUriTemplate: '/dossiers/{dossierId}/complaint-judgement-document/{mainDocumentId}',
        ),
        new Post(
            uriTemplate: '/dossiers/{dossierId}/complaint-judgement-document',
            uriVariables: [
