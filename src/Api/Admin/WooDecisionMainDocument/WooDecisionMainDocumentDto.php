...
#[ApiResource(
    uriTemplate: '/woo-decision-main-document/{mainDocumentId}',
    operations: [
        new Get(
            security: "is_granted('AuthMatrix.dossier.read')",
        ),
        new GetCollection(
            uriTemplate: '/woo-decision-main-document',
            uriVariables: [
                'dossierId' => new Link(toProperty: 'dossier', fromClass: DossierReferenceDto::class),
            ],
            security: "is_granted('AuthMatrix.dossier.read')",
            itemUriTemplate: '/woo-decision-main-document/{mainDocumentId}',
        ),
        new Post(
            uriTemplate: '/woo-decision-main-document',
            uriVariables: [
    ...
    provider: WooDecisionMainDocumentProvider::class,
    processor: WooDecisionMainDocumentProcessor::class,
)]
final readonly class WooDecisionMainDocumentDto extends AbstractMainDocumentDto
{
}
