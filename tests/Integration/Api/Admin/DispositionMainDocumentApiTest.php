...
use Shared\Api\Admin\DispositionMainDocument\DispositionMainDocumentDto;
...
final class DispositionMainDocumentApiTest extends AdminApiTestCase
{
    ...
    public function testGetDispositionDocumentReturnsEmptySetUntilCreated(): void
    {
    ...
    public function testUpdateDispositionDocument(): void
    {
        ...
        $updateResponse = self::createAdminApiClient($user)
            ->request(
                Request::METHOD_PUT,
                sprintf(
                    '/balie/api/dossiers/%s/disposition-document/%s',
