...
use App\Api\Admin\ComplaintJudgmentDocument\ComplaintJudgementDocumentDto;
...
final class ComplaintJudgementDocumentTest extends ApiTestCase
{
    ...
    public function testGetComplaintJudgementDocumentReturns404UntilCreated(): void
    {
        ...
        self::assertMatchesResourceItemJsonSchema(ComplaintJudgementDocumentDto::class);
    }
            ...
            [
                ...
                'extra' => [
                    'parameters' => [
                        'chunkindex' => '0',
                        'totalchunkcount' => '1',
                        'groupId' => UploadGroupId::COMPLAINT_JUDGEMENT_DOCUMENTS->value,
                        'uuid' => $uploadUuid,
                    ],
                    'files' => [
                        'file' => $uploadFile,
