...
use App\Api\Admin\RequestForAdviceAttachment\RequestForAdviceAttachmentDto;
...
use App\Tests\Factory\Publication\Dossier\Type\RequestForAdvice\RequestForAdviceAttachmentFactory;
...
final class RequestForAdviceAttachmentTest extends AdminApiTestCase
{
    ...
    public function testGetAllRequestForAdviceAttachments(): void
    {
        ...
        RequestForAdviceAttachmentFactory::createMany(5, ['dossier' => $dossier]);

        $response = self::createAdminApiClient($user)
            ->request(
                Request::METHOD_GET,
                sprintf('/balie/api/dossiers/%s/request-for-advice-attachments', $dossier->getId()),
            );

        self::assertResponseIsSuccessful();
        self::assertMatchesResourceCollectionJsonSchema(RequestForAdviceAttachmentDto::class);
        self::assertCount(5, $response->toArray(), 'Expected 5 RequestForAdvice attachments');
    }

    public function testGetSingleRequestForAdviceAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create()->_real();
        ...
        self::createAdminApiClient($user)
            ->request(
                Request::METHOD_GET,
                sprintf('/balie/api/dossiers/%s/request-for-advice-attachments/%s', $attachment->getDossier()->getId(), $attachment->getId()),
            );

        self::assertResponseIsSuccessful();
        self::assertMatchesResourceItemJsonSchema(RequestForAdviceAttachmentDto::class);
    }

    public function testGetSingleNonExistingRequestForAdviceAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create()->_real();
        ...
        self::createAdminApiClient($user)
            ->request(
                Request::METHOD_GET,
                sprintf('/balie/api/dossiers/%s/request-for-advice-attachments/%s', $dossier->getId(), $this->getFaker()->uuid()),
            );

        self::assertResponseStatusCodeSame(Response::HTTP_NOT_FOUND);
    }

    public function testCreateRequestForAdviceAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create()->_real();
        $organisation = $user->getOrganisation();
        $dossier = RequestForAdviceFactory::createOne(['organisation' => $organisation])->_real();
    ...
    public function testCreateRequestForAdviceAttachmentWithInvalidRequestData(array $input, array $expectedViolations): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create()->_real();
    ...
    public function testDeleteRequestForAdviceAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create()->_real();
    ...
    public function testDeleteNonExistingRequestForAdviceAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create()->_real();
    ...
    public function testUpdateRequestForAdviceAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create()->_real();
    ...
    public function testUpdateNonExistingRequestForAdviceAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create()->_real();
    ...
    public function testUpdateRequestForAdviceAttachmentWithInvalidRequestData(array $input, array $expectedViolations): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create()->_real();
