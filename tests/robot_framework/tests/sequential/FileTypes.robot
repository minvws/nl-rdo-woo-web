...
Verify Filetypes Of Uploaded Dossier
  Depends On Test  Create A Dossier With Different Filetypes Using Individual Files, Zip And 7z
...
Verify Filetypes Available In Search
  [Template]  Verify Filetypes On Public
  16101.docx  16101
  16102.doc  16102
  16103.odt  16103
  16109.xlsx  16109
...
Verify Filetypes On Public
  [Arguments]  ${search_term}  ${search_results}
  Depends On Test  Create A Dossier With Different Filetypes Using Individual Files, Zip And 7z
  Search On Public For  ${search_term}  ${search_results}
