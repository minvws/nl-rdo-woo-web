...
Send Put Request Disposition
  ...
  ...  url=${URL_API}/api/publication/v1/organisation/${ORGANISATION_ID}/dossiers/disposition/external/${external_id}
  ...  json=${body}
  ...  expected_status=any
  Should Be True
...
Verify HAL Links Are Reachable
  ...
  Verify HAL Links Are Reachable For Dossier  disposition
