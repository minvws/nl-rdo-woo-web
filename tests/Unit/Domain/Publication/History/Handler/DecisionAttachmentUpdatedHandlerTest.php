...
use App\Domain\Publication\History\Handler\DecisionAttachment\DecisionAttachmentUpdatedHandler;
...
final class DecisionAttachmentUpdatedHandlerTest extends UnitTestCase
{
    public function testInvokeOnPublishedDossier(): void
    {
        ...
        $event = new DecisionAttachmentUpdatedEvent($decisionAttachment);
        ...
        $handler = new DecisionAttachmentUpdatedHandler($historyService);
