...
class DossierWorkflowGuardTest extends UnitTestCase
{
    public function testGetSubscribedEvents(): void
    {
        $expectedSubscribedEvents = [
            ...
            'workflow.draft_decision_workflow.guard.publish' => ['guardDossier'],
            'workflow.draft_decision_workflow.guard.publish_as_preview' => ['guardDossier'],
            'workflow.draft_decision_workflow.guard.schedule_publish' => ['guardDossier'],
