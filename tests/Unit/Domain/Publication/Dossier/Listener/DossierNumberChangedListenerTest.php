...
use Shared\Domain\Publication\Dossier\Listener\DossierNumberChangedListener;
use Shared\Domain\Publication\Dossier\Type\WooDecision\WooDecision;
use Shared\Tests\Unit\UnitTestCase;
use Symfony\Component\Uid\Uuid;
use Symfony\Contracts\EventDispatcher\EventDispatcherInterface;

class DossierNumberChangedListenerTest extends UnitTestCase
{
    public function testEventDispatchedWhenDossierNumberChanges(): void
    {
        ...
        $listener = new DossierNumberChangedListener($dispatcher);
