...
use App\Domain\Publication\Dossier\Type\Covenant\Handler\UpdateCovenantDetailsHandler;
...
class UpdateCovenantDetailsHandlerTest extends MockeryTestCase
{
    private MessageBusInterface&MockInterface $messageBus;
    private DossierWorkflowManager&MockInterface $dossierWorkflowManager;
    private UpdateCovenantDetailsHandler $handler;
    ...
    public function setUp(): void
    {
        ...
        $this->handler = new UpdateCovenantDetailsHandler(
    ...
    public function testInvokeSuccessfully(): void
    {
        ...
        $this->handler->__invoke(
            new UpdateCovenantDetailsCommand($covenant)
        );
    }
