...
use App\Domain\Publication\Dossier\Type\WooDecision\Handler\RemoveInventoryAndDocumentsHandler;
...
class RemoveInventoryAndDocumentsHandlerTest extends UnitTestCase
{
    ...
    public function testInvokeSuccessful(): void
    {
        ...
        $this->batchDownloadService->expects('refreshForEntity')->with($dossier);
