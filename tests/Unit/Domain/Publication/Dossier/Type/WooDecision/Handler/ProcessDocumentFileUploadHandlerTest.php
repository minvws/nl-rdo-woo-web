...
use App\Domain\Publication\Dossier\Type\WooDecision\Handler\ProcessDocumentFileUploadHandler;
...
class ProcessDocumentFileUploadHandlerTest extends UnitTestCase
{
    ...
    public function testInvokeSuccessfully(): void
    {
        ...
        $upload->expects('setStatus')->with(DocumentFileUploadStatus::PROCESSED);
        ...
        $this->entityStorageService->expects('removeFileForEntity')->with($upload);
