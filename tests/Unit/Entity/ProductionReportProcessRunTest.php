...
final class ProductionReportProcessRunTest extends UnitTestCase
{
    ...
    public function testSetChangesetSetsStatusToNeedsConfirmationWhenDossierIsPubliclyAvailable(): void
    {
    ...
    public function testSetChangesetSetsStatusToConfirmedWhenDossierIsNotPubliclyAvailable(): void
    {
        $this->wooDecision->expects('getStatus')->andReturn(DossierStatus::CONCEPT);
