...
/**
 * @extends PersistentProxyObjectFactory<OtherPublicationMainDocument>
 */
final class OtherPublicationMainDocumentFactory extends PersistentProxyObjectFactory
{
    /**
    ...
    protected function defaults(): array
    {
        return [
            ...
            'type' => self::faker()->randomElement(OtherPublicationMainDocument::getAllowedTypes()),
