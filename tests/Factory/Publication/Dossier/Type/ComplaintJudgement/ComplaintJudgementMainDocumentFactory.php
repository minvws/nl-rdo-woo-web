...
/**
 * @extends PersistentProxyObjectFactory<ComplaintJudgementMainDocument>
 */
final class ComplaintJudgementMainDocumentFactory extends PersistentProxyObjectFactory
{
    /**
