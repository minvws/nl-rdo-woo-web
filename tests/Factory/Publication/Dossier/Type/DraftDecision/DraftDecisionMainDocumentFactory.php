...
/**
 * @extends PersistentObjectFactory<DraftDecisionMainDocument>
 */
final class DraftDecisionMainDocumentFactory extends PersistentObjectFactory
{
    /**
    ...
    protected function defaults(): array
    {
        return [
            ...
            'type' => self::faker()->randomElement(DraftDecisionMainDocument::getAllowedTypes()),
