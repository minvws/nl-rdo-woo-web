...
use Admin\Form\User\DisableUserFormType;
use Admin\Form\User\EnableUserFormType;
use Admin\Form\User\ResetPasswordFormType;
use Admin\Form\User\ResetTwoFactorAuthFormType;
use Admin\Form\User\UserCreateFormType;
use Admin\Form\User\UserInfoFormType;
...
class UserController extends AbstractController
{
    ...
    public function modify(Request $request, User $user): Response
    {
        ...
        return $this->render('admin/user/edit.html.twig', [
            ...
            'user_reset_password' => $userResetPasswordForm,
            'user_reset_two_factor_auth' => $userResetTwoFactorAuthForm,
            'user_disable' => $userDisableForm,
            'user_enable' => $userEnableForm,
        ]);
    }
