...
#[ApiResource(
    uriTemplate: '/request-for-advice-document/{mainDocumentId}',
    operations: [
        new Get(
            security: "is_granted('AuthMatrix.dossier.read')",
        ),
        new GetCollection(
            uriTemplate: '/request-for-advice-document',
            uriVariables: [
                'dossierId' => new Link(toProperty: 'dossier', fromClass: DossierReferenceDto::class),
            ],
            security: "is_granted('AuthMatrix.dossier.read')",
            itemUriTemplate: '/request-for-advice-document/{mainDocumentId}',
        ),
        new Post(
            uriTemplate: '/request-for-advice-document',
            uriVariables: [
