...
#[ApiResource(
    uriTemplate: '/draft-decision-document/{mainDocumentId}',
    operations: [
        new Get(
            security: "is_granted('AuthMatrix.dossier.read')",
        ),
        new GetCollection(
            uriTemplate: '/draft-decision-document',
            uriVariables: [
                'dossierId' => new Link(toProperty: 'dossier', fromClass: DossierReferenceDto::class),
            ],
            security: "is_granted('AuthMatrix.dossier.read')",
            itemUriTemplate: '/draft-decision-document/{mainDocumentId}',
        ),
        new Post(
            uriTemplate: '/draft-decision-document',
            uriVariables: [
    ...
    provider: DraftDecisionMainDocumentProvider::class,
    processor: DraftDecisionMainDocumentProcessor::class,
)]
final readonly class DraftDecisionMainDocumentDto extends AbstractMainDocumentDto
{
}
