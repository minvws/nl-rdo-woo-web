...
use Admin\Api\Admin\DraftDecisionAttachment\DraftDecisionAttachmentDto;
...
final class DraftDecisionAttachmentTest extends AdminApiTestCase
{
    ...
    public function testGetAllDraftDecisionAttachments(): void
    {
        ...
        DraftDecisionAttachmentFactory::createMany(5, ['dossier' => $dossier]);

        $response = self::createAdminApiClient($user)
            ->request(
                Request::METHOD_GET,
                sprintf('/balie/api/dossiers/%s/draft-decision-attachments', $dossier->getId()),
            );

        self::assertResponseIsSuccessful();
        self::assertMatchesResourceCollectionJsonSchema(DraftDecisionAttachmentDto::class);
        self::assertCount(5, $response->toArray(), 'Expected 5 Draft decision attachments');
    }

    public function testGetSingleDraftDecisionAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create();
        ...
        self::createAdminApiClient($user)
            ->request(
                Request::METHOD_GET,
                sprintf('/balie/api/dossiers/%s/draft-decision-attachments/%s', $attachment->getDossier()->getId(), $attachment->getId()),
            );

        self::assertResponseIsSuccessful();
        self::assertMatchesResourceItemJsonSchema(DraftDecisionAttachmentDto::class);
    }

    public function testGetSingleNonExistingDraftDecisionAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create();
        ...
        self::createAdminApiClient($user)
            ->request(
                Request::METHOD_GET,
                sprintf('/balie/api/dossiers/%s/draft-decision-attachments/%s', $dossier->getId(), Uuid::v6()),
            );

        self::assertResponseStatusCodeSame(Response::HTTP_NOT_FOUND);
    }

    public function testCreateDraftDecisionAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create();
        $organisation = $user->getOrganisation();
        $dossier = DraftDecisionFactory::createOne(['organisation' => $organisation]);
    ...
    public function testCreateDraftDecisionAttachmentWithInvalidRequestData(array $input, array $expectedViolations): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create();
    ...
    public function testDeleteDraftDecisionAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create();
    ...
    public function testDeleteNonExistingDraftDecisionAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create();
    ...
    public function testUpdateDraftDecisionAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create();
    ...
    public function testUpdateNonExistingDraftDecisionAttachment(): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create();
        ...
        self::createAdminApiClient($user)
            ->request(
                Request::METHOD_GET,
                sprintf('/balie/api/dossiers/%s/draft-decision-attachments/%s', $dossier->getId(), $this->getFaker()->uuid()),
            );
    ...
    public function testUpdateDraftDecisionAttachmentWithInvalidRequestData(array $input, array $expectedViolations): void
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create();
