...
use Admin\Api\Admin\OtherPublicationMainDocument\OtherPublicationMainDocumentDto;
...
final class OtherPublicationMainDocumentTest extends AdminApiTestCase
{
    ...
    public function testGetOtherPublicationDocumentReturnsEmptySetUntilCreated(): void
    {
    ...
    public function testUpdateOtherPublicationDocument(): void
    {
        ...
        $updateResponse = self::createAdminApiClient($user)
            ->request(
                Request::METHOD_PUT,
                sprintf(
                    '/balie/api/dossiers/%s/other-publication-document/%s',
        ...
        self::createAdminApiClient($user)
            ->request(
                ...
                sprintf(
                    '/balie/api/dossiers/%s/other-publication-document/%s',
                    $dossier->getId(),
                    $otherPublicationMainDocument->getId(),
                ),
            );
