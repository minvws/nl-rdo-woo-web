...
use Admin\Api\Admin\InvestigationReportAttachment\InvestigationReportAttachmentDto;
...
final class InvestigationReportAttachmentTest extends AdminApiTestCase
{
    ...
    {
        $user = UserFactory::new()->asSuperAdmin()->isEnabled()->create();
        $otherOrganisation = OrganisationFactory::new()->create();
        $attachment = InvestigationReportAttachmentFactory::createOne([
            'dossier' => InvestigationReportFactory::createOne([
    ...
    {
        $user = UserFactory::new()->asOrganisationAdmin()->isEnabled()->create();
        $otherOrganisation = OrganisationFactory::new()->create();
