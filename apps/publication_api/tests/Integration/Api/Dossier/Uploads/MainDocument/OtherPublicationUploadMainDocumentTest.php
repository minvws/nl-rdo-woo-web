...
final class OtherPublicationUploadMainDocumentTest extends ApiPublicationV1UploadTestCase
{
    public function testUpload(): void
    {
        ...
        $otherPublication = OtherPublicationFactory::new()->concept()->create([
        ...
        $this->assertUpload(
            url: sprintf(
                '/api/publication/v1/organisation/%s/dossiers/other-publication/external/%s/uploads/main-document',
                $organisation->getId(),
