...
final class InvestigationReportPublicationV1Test extends ApiPublicationV1DossierTestCase
{
    ...
    public function testGetInvestigationReportCollection(): void
    {
        ...
        self::assertJsonContains(['items' => [['externalId' => $investigationReport->getExternalId()?->toString()]]]);
    }
    ...
    public function testGetInvestigationReport(): void
    {
        ...
        $expectedResponse = [
            ...
            '_links' => [
                'self' => ['href' => $this->buildApiUrl($organisation, $investigationReport)],
                'public' => ['href' => $dossierPathHelper->getAbsoluteDetailsPath($investigationReport)],
            ],
        ];
    ...
    public function testCreateInvestigationReportWithoutMainDocumentNorNotice(): void
    {
        $organisation = OrganisationFactory::createOne();
        $subject = SubjectFactory::new(['organisation' => $organisation])->create();
        $department = DepartmentFactory::new(['organisations' => [$organisation]])->create();
    ...
    public function testCreateInvestigationReportWithExternalIdAlreadyUsedByComplaintJudgementReturnsConflict(): void
    {
        $organisation = OrganisationFactory::createOne();
        $subject = SubjectFactory::new(['organisation' => $organisation])->create();
        $department = DepartmentFactory::new(['organisations' => [$organisation]])->create();
    ...
    public function testCreateInvestigationReportWithBothMainDocumentAndNoticeNotPublic(): void
    {
        $organisation = OrganisationFactory::createOne();
        $subject = SubjectFactory::new(['organisation' => $organisation])->create();
        $department = DepartmentFactory::new(['organisations' => [$organisation]])->create();
    ...
    public function testCreateInvestigationReportWithNoticeNotPublic(): void
    {
        $organisation = OrganisationFactory::createOne();
        $subject = SubjectFactory::new(['organisation' => $organisation])->create();
        $department = DepartmentFactory::new(['organisations' => [$organisation]])->create();
    ...
    public function testCreateInvestigationReportWithNoticeNotPublicAndEmptyGrounds(): void
    {
        $organisation = OrganisationFactory::createOne();
        $subject = SubjectFactory::new(['organisation' => $organisation])->create();
        $department = DepartmentFactory::new(['organisations' => [$organisation]])->create();
    ...
    public function testCreateInvestigationReportWithNoticeNotPublicAndMissingFormalDate(): void
    {
        $organisation = OrganisationFactory::createOne();
        $subject = SubjectFactory::new(['organisation' => $organisation])->create();
        $department = DepartmentFactory::new(['organisations' => [$organisation]])->create();
    ...
    public function testUpdateInvestigationReportTransitionsFromMainDocumentToNoticeNotPublic(): void
    {
        $organisation = OrganisationFactory::createOne();
        $department = DepartmentFactory::new(['organisations' => [$organisation]])->create();
        $investigationReport = InvestigationReportFactory::createOne([
        ...
        self::assertDatabaseHas(InvestigationReportMainDocument::class, [
            'id' => $mainDocumentId,
        ]);
        ...
        $response = self::createPublicationApiRequest(Request::METHOD_PUT, $this->buildUrl($organisation, $investigationReport), ['json' => $data]);
        self::assertResponseIsSuccessful();
        ...
        self::assertDatabaseCount(NoticeNotPublic::class, 1);
        self::assertDatabaseMissing(InvestigationReportMainDocument::class, [
            'id' => $mainDocumentId,
        ]);
    }

    public function testUpdateInvestigationReportTransitionsFromNoticeNotPublicToMainDocument(): void
    {
        $organisation = OrganisationFactory::createOne();
        $department = DepartmentFactory::new(['organisations' => [$organisation]])->create();
        $investigationReport = InvestigationReportFactory::createOne([
        ...
        NoticeNotPublicFactory::createOne(['dossier' => $investigationReport]);

        self::assertDatabaseCount(NoticeNotPublic::class, 1);
        self::assertDatabaseCount(InvestigationReportMainDocument::class, 0);
