...
final readonly class DossierTitlePropertyMetadataFactory implements PropertyMetadataFactoryInterface
{
    ...
    public function create(string $resourceClass, string $property, array $options = []): ApiProperty
    {
        ...
        if (! $unwrapped instanceof ObjectType || $unwrapped->getClassName() !== DossierTitle::class) {
            return $propertyMetadata;
        }
