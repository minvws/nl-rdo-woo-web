...
final readonly class FileNamePropertyMetadataFactory implements PropertyMetadataFactoryInterface
{
    ...
    public function create(string $resourceClass, string $property, array $options = []): ApiProperty
    {
        ...
        if (! $unwrapped instanceof ObjectType || $unwrapped->getClassName() !== FileName::class) {
            return $propertyMetadata;
        }
