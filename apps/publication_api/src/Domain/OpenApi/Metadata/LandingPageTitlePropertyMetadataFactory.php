...
final readonly class LandingPageTitlePropertyMetadataFactory implements PropertyMetadataFactoryInterface
{
    ...
    public function create(string $resourceClass, string $property, array $options = []): ApiProperty
    {
        ...
        if (! $unwrapped instanceof ObjectType || $unwrapped->getClassName() !== LandingPageTitle::class) {
            return $propertyMetadata;
        }

        $schema = [
            'type' => 'string',
            'minLength' => LandingPageTitle::MIN_LENGTH,
            'maxLength' => LandingPageTitle::MAX_LENGTH,
        ];
