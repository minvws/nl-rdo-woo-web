...
final readonly class OtherPublicationMainDocumentResponseDto implements MainDocumentResponseDtoInterface
{
    /**
    ...
    {
        return OtherPublicationMainDocument::getAllowedTypes();
    }
}
