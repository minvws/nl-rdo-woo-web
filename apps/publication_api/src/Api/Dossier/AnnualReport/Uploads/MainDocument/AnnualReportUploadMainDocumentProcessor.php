...
final readonly class AnnualReportUploadMainDocumentProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): void
    {
        ...
        $this->uploadMainDocumentProcessor->process($data, $this->annualReportRepository, AnnualReportMainDocument::class);
    }
}
