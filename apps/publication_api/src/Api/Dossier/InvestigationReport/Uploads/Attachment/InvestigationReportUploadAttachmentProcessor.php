...
final readonly class InvestigationReportUploadAttachmentProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): void
    {
        ...
        $this->uploadAttachmentProcessor->process($data, $this->investigationReportRepository, InvestigationReportAttachment::class);
    }
}
