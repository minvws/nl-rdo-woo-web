...
final readonly class DossierSupportService
{
     ...
     */
    public function getOrganisation(array $uriVariables): Organisation
    {
    ...
    public function removeDossierAttachments(EntityWithAttachments $entityWithAttachments): void
    {
