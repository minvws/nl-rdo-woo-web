...
#[ApiResource(
    operations: [
        new Get(
            uriTemplate: '/organisation/{organisationId}/dossiers/complaint-judgement/E:{complaintJudgementExternalId}',
        ),
        new GetCollection(
            ...
            itemUriTemplate: '/organisation/{organisationId}/dossiers/complaint-judgement/{complaintJudgementExternalId}',
        ),
        new Put(
            uriTemplate: '/organisation/{organisationId}/dossiers/complaint-judgement/E:{complaintJudgementExternalId}',
    ...
    uriVariables: [
        'organisationId' => new Link(toProperty: 'organisation', fromClass: OrganisationReferenceDto::class),
        'complaintJudgementExternalId' => new Link(fromClass: self::class, identifiers: ['externalId']),
    ],
    stateless: false,
    openapi: new Operation(
        tags: ['ComplaintJudgement'],
...
final class ComplaintJudgementDto implements DossierDtoInterface
{
