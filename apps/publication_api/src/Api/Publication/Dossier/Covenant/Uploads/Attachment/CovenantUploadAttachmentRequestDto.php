...
#[ApiResource(
    ...
    operations: [
        new Put(
            uriTemplate: '/organisation/{organisationId}/dossiers/covenant/E:{dossierExternalId}/uploads/attachment/E:{attachmentExternalId}',
...
final readonly class CovenantUploadAttachmentRequestDto implements UploadAttachmentRequestInterface
{
