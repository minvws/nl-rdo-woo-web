...
#[ApiResource(
    operations: [
        new Get(
            uriTemplate: '/organisation/{organisationId}/dossiers/disposition/E:{dispositionExternalId}',
        ),
        new GetCollection(
            ...
            itemUriTemplate: '/organisation/{organisationId}/dossiers/disposition/E:{dispositionExternalId}',
        ),
        new Put(
            uriTemplate: '/organisation/{organisationId}/dossiers/disposition/E:{dispositionExternalId}',
    ...
    uriVariables: [
        'organisationId' => new Link(toProperty: 'organisation', fromClass: OrganisationReferenceDto::class),
        'dispositionExternalId' => new Link(fromClass: self::class, identifiers: ['externalId']),
    ],
    stateless: false,
    openapi: new Operation(
        tags: ['Disposition'],
...
final class DispositionDto implements DossierDtoInterface
{
    /**
