...
#[ApiResource(
    ...
    operations: [
        new Get(
            ...
            uriTemplate: '/organisation/{organisationId}/dossiers/disposition/E:{dossierExternalId}',
        ),
        new GetCollection(
            ...
            itemUriTemplate: '/organisation/{organisationId}/dossiers/disposition/E:{dossierExternalId}',
        ),
        new Put(
