...
#[ApiResource(
    ...
    operations: [
        new Put(
            uriTemplate: '/organisation/{organisationId}/dossiers/disposition/E:{dossierExternalId}/uploads/main-document',
            ...
            read: false,
            deserialize: false,
            name: 'disposition_main_document_upload',
...
final readonly class DispositionUploadMainDocumentRequestDto implements UploadMainDocumentRequestInterface
{
