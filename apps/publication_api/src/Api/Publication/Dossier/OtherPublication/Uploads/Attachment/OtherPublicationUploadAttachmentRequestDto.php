...
#[ApiResource(
    ...
    operations: [
        new Put(
            ...
            uriTemplate: '/organisation/{organisationId}/dossiers/other-publication/E:{dossierExternalId}/uploads/attachment/E:{attachmentExternalId}',
...
final readonly class OtherPublicationUploadAttachmentRequestDto implements UploadAttachmentRequestInterface
{
