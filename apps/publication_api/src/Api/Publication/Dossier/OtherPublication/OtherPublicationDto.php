...
#[ApiResource(
    operations: [
        new Get(
            uriTemplate: '/organisation/{organisationId}/dossiers/other-publication/E:{otherPublicationExternalId}',
        ),
        new GetCollection(
            ...
            itemUriTemplate: '/organisation/{organisationId}/dossiers/other-publication/E:{otherPublicationExternalId}',
        ),
        new Put(
            uriTemplate: '/organisation/{organisationId}/dossiers/other-publication/E:{otherPublicationExternalId}',
    ...
    uriVariables: [
        'organisationId' => new Link(toProperty: 'organisation', fromClass: OrganisationReferenceDto::class),
        'otherPublicationExternalId' => new Link(fromClass: self::class, identifiers: ['externalId']),
    ],
    stateless: false,
    openapi: new Operation(
        tags: ['OtherPublication'],
...
final class OtherPublicationDto implements DossierDtoInterface
{
    /**
