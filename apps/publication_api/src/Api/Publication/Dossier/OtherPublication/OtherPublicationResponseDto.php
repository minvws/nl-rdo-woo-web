...
#[ApiResource(
    ...
    operations: [
        new Get(
            ...
            uriTemplate: '/organisation/{organisationId}/dossiers/other-publication/E:{dossierExternalId}',
        ),
        new GetCollection(
            ...
            itemUriTemplate: '/organisation/{organisationId}/dossiers/other-publication/E:{dossierExternalId}',
        ),
        new Put(
...
final class OtherPublicationResponseDto
{
    /**
