...
#[ApiResource(
    ...
    operations: [
        new Put(
            uriTemplate: '/organisation/{organisationId}/dossiers/advice/E:{dossierExternalId}/uploads/attachment/E:{attachmentExternalId}',
...
final readonly class AdviceUploadAttachmentRequestDto implements UploadAttachmentRequestInterface
{
