...
#[ApiResource(
    ...
    operations: [
        new Get(
            name: 'get_advice',
            uriTemplate: '/organisation/{organisationId}/dossiers/advice/E:{dossierExternalId}',
        ),
        new GetCollection(
            name: 'get_advices',
            ...
            itemUriTemplate: '/organisation/{organisationId}/dossiers/advice/E:{dossierExternalId}',
        ),
        new Put(
            name: 'update_advice',
            uriTemplate: '/organisation/{organisationId}/dossiers/advice/E:{dossierExternalId}',
