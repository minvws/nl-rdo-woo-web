...
#[ApiResource(
    ...
    operations: [
        new Put(
            ...
            uriTemplate: '/organisation/{organisationId}/dossiers/investigation-report/E:{dossierExternalId}/uploads/attachment/E:{attachmentExternalId}',
            ...
            read: false,
            deserialize: false,
            name: 'investigation_report_attachment_upload',
