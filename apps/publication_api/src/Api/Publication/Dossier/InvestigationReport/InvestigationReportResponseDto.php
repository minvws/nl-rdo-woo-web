...
#[ApiResource(
    ...
    operations: [
        new Get(
            ...
            uriTemplate: '/organisation/{organisationId}/dossiers/investigation-report/E:{dossierExternalId}',
        ),
        new GetCollection(
            ...
            itemUriTemplate: '/organisation/{organisationId}/dossiers/investigation-report/E:{dossierExternalId}',
        ),
        new Put(
...
final class InvestigationReportResponseDto
{
    /**
