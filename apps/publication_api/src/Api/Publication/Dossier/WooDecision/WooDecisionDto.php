...
#[ApiResource(
    operations: [
        new Get(
            uriTemplate: '/organisation/{organisationId}/dossiers/woo-decision/E:{wooDecisionExternalId}',
        ),
        new GetCollection(
            ...
            itemUriTemplate: '/organisation/{organisationId}/dossiers/woo-decision/E:{wooDecisionExternalId}',
        ),
        new Put(
            uriTemplate: '/organisation/{organisationId}/dossiers/woo-decision/E:{wooDecisionExternalId}',
    ...
    uriVariables: [
        'organisationId' => new Link(toProperty: 'organisation', fromClass: OrganisationReferenceDto::class),
        'wooDecisionExternalId' => new Link(fromClass: self::class, identifiers: ['externalId']),
    ],
    stateless: false,
    openapi: new Operation(
        tags: ['WooDecision'],
...
final class WooDecisionDto implements DossierDtoInterface
{
    /**
