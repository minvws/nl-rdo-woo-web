...
#[ApiResource(
    operations: [
        new Get(
            uriTemplate: '/organisation/{organisationId}/dossiers/annual-report/E:{annualReportExternalId}',
        ),
        new GetCollection(
            ...
            itemUriTemplate: '/organisation/{organisationId}/dossiers/annual-report/E:{annualReportExternalId}',
        ),
        new Put(
            uriTemplate: '/organisation/{organisationId}/dossiers/annual-report/E:{annualReportExternalId}',
    ...
    uriVariables: [
        'organisationId' => new Link(toProperty: 'organisation', fromClass: OrganisationReferenceDto::class),
        'annualReportExternalId' => new Link(fromClass: self::class, identifiers: ['externalId']),
    ],
    stateless: false,
    openapi: new Operation(
        tags: ['AnnualReport'],
...
final class AnnualReportDto implements DossierDtoInterface
{
    /**
