...
namespace PublicationApi\Command;
...
class PostDeployPublicationApi extends Command
{
    ...
    private function createOpenApiSpecFiles(SymfonyStyle $io): int
    {
        ...
        $openApiArguments = [
            ['--output' => $this->publicDir . '/api/publication/v1/openapi.json'],
            ['--output' => $this->publicDir . '/api/publication/v1/openapi.yaml', '--yaml' => true],
        ];
